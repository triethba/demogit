<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Webeporjct.Login" %>
...
<div id="middlepart">  <%--noi dung chinh--%>
    <asp:Label ID="Label1" runat="server" Font-Names="Aharoni" Font-Size="XX-Large" Text="Login Customer"></asp:Label>
    <br />
    <br />
    <br />
    <asp:Label ID="Label2" runat="server" Font-Names="Aachen" Font-Size="Large" Text="UserName"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:TextBox ID="txtUsername" runat="server" Width="225px"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUsername" ErrorMessage="Username Not NULL" ForeColor="#CC0000"></asp:RequiredFieldValidator>
    <br />
    <asp:Label ID="Label3" runat="server" Font-Names="Aachen" Font-Size="Large" Text="Password"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:TextBox ID="txtPassword" runat="server" Width="227px"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPassword" ErrorMessage="Password Not NULL" ForeColor="#CC0000"></asp:RequiredFieldValidator>
    <br />
    ...
    <br />
    <br />
    <asp:Button ID="btnLogin" runat="server" Font-Size="X-Large" OnClick="btnLogin_Click" Text="Login" />
